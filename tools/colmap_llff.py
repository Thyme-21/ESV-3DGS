...
for scene in ['fern', 'flower', 'fortress',  'horns',  'leaves',  'orchids',  'room',  'trex']:# ['bonsai', 'counter', 'garden', 'kitchen', 'room', 'stump']:
    pipeline(scene, base_path = '/media/zgy/data/pyf/CoR-GS/data/nerf_llff_data/', n_views = 3)  # please use absolute path!

# pipeline('leaves', base_path = '/media/zgy/data/pyf/CoR-GS/data/nerf_llff_data/', n_views = 6)